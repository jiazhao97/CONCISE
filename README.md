...
CONCISE jointly models intrinsic features of ST count data, including spatial autocorrelation, varying total molecular counts and measurement errors, all of which can lead to spurious results if ignored. By explicitly accounting for these sources of confounding, CONCISE enables reliable inference with well-calibrated false-positive control and higher detection power. With efficient moment-based parameter estimation and analytically derived hypothesis testing, CONCISE avoids computationally intensive permutation procedures and restrictive distributional assumptions, achieving rigorous inference while maintaining high robustness and computational efficiency.
